export const VERIFICATION_EMAIL_TEMPLATE = (verificationCode, username) =>  `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #215387, #215387); padding: 20px; text-align: center;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <span style="font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #215387;">${verificationCode}</span>
    </div>
    <p>Enter this code on the verification page to complete your registration.</p>
    <p>This code will expire in 12 hours  for security reasons.</p>
    <p>If expired you can re-create the account with same credentials .</p>
